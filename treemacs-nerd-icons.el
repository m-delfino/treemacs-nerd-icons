                       ...
                       (progn
                         (dolist (item nerd-icons-extension-icon-alist)
                           (let* ((extension (car item))
                             ...
                             (let* ((icon-pair (cons (format "%s " icon) (format "%s " icon)))
                         ...
                         (treemacs-create-icon :icon (format "%s%s" (nerd-icons-faicon "nf-fa-folder"  :face 'treemacs-nerd-icons-file-face) treemacs-nerd-icons-tab)
                                               ...
                                               :fallback 'same-as-icon)
                         (treemacs-create-icon :icon (format "%s%s" (nerd-icons-codicon "nf-cod-folder_opened"  :face 'treemacs-nerd-icons-file-face) treemacs-nerd-icons-tab)
                                               :extensions ("src-open")
                                               :fallback 'same-as-icon)
                         (treemacs-create-icon :icon (format "%s%s" (nerd-icons-codicon "nf-cod-folder"  :face 'treemacs-nerd-icons-file-face) treemacs-nerd-icons-tab)
                         ...
                         (treemacs-create-icon :icon (format "%s%s" (nerd-icons-faicon "nf-fa-folder_open"  :face 'treemacs-nerd-icons-file-face) treemacs-nerd-icons-tab)
                                               :extensions ("git-open")
                                               :fallback 'same-as-icon)
                         (treemacs-create-icon :icon (format "%s%s" (nerd-icons-sucicon "nf-custom-folder_git"  :face 'treemacs-nerd-icons-file-face) treemacs-nerd-icons-tab)
                                               :extensions ("git-closed")
                                               :fallback 'same-as-icon)
                         (treemacs-create-icon :icon (format "%s%s" (nerd-icons-faicon "nf-fa-folder_open"  :face 'treemacs-nerd-icons-file-face) treemacs-nerd-icons-tab)
                                               :extensions ("github-open")
                                               :fallback 'same-as-icon)
                         (treemacs-create-icon :icon (format "%s%s" (nerd-icons-sucicon "nf-custom-folder_github"  :face 'treemacs-nerd-icons-file-face) treemacs-nerd-icons-tab)
                         ...
                         (treemacs-create-icon :icon (format "%s " (nerd-icons-faicon "nf-fa-file_o" :face 'treemacs-nerd-icons-file-face))
                                               :extensions (fallback)
                                               :fallback 'same-as-icon)))
